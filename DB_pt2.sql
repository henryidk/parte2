/* =========================================================
   MÓDULO DE LOGIN/USUARIOS – VERSIÓN SOLO CREAR (SIN DROPS)
...
IF OBJECT_ID('seg.sp_GenerarPasswordTemporal') IS NULL
    EXEC('CREATE PROCEDURE seg.sp_GenerarPasswordTemporal AS BEGIN SELECT 1; END');
GO

ALTER PROCEDURE seg.sp_GenerarPasswordTemporal
    @Correo             VARCHAR(120),
...
-- Limpieza de contraseñas temporales expiradas
...
------------------------------------------------------------
-- 5) REGISTRAR USUARIOS INICIALES
------------------------------------------------------------
DECLARE @msg NVARCHAR(200);

-- Solo registrar si no existen
...
PRINT '✅ Módulo de login/usuarios creado correctamente.';
GO